		...
		<div id="page-imageresize">
			<fieldset class="adminform form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<fieldset id="rsformConfig_imgresize_log" class="btn-group radio">
							<input type="radio" id="rsformConfig_imgresize_log1" name="rsformConfig[imgresize_log]" value="1" <?php if ($imgresize_log == 1) echo 'checked="checked"';?> />
							<label for="rsformConfig_imgresize_log1" >
								<?php echo JText::_('JYES'); ?>
							</label>
							<input type="radio" id="rsformConfig_imgresize_log0" name="rsformConfig[imgresize_log]" value="0" <?php if ($imgresize_log == 0) echo 'checked="checked"';?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<fieldset id="rsformConfig_imgresize_do_tn" class="btn-group radio">
							<input type="radio" id="rsformConfig_imgresize_do_tn1" name="rsformConfig[imgresize_do_tn]" value="1" <?php if ($do_tn == 1) echo 'checked="checked"';?> />
							<label for="rsformConfig_imgresize_do_tn1" >
								<?php echo JText::_('JYES'); ?>
							</label>
							<input type="radio" id="rsformConfig_imgresize_do_tn0" name="rsformConfig[imgresize_do_tn]" value="0" <?php if ($do_tn == 0) echo 'checked="checked"';?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_tn_width]" id="rsformConfig_imgresize_tn_width" value="<?php echo $tn_width;?>" />
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_tn_height]" id="rsformConfig_imgresize_tn_height" value="<?php echo $tn_height;?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<fieldset id="rsformConfig_imgresize_do_xs" class="btn-group radio">
							<input type="radio" id="rsformConfig_imgresize_do_xs1" name="rsformConfig[imgresize_do_xs]" value="1" <?php if ($do_xs == 1) echo 'checked="checked"';?> />
							<label for="rsformConfig_imgresize_do_xs1" >
								<?php echo JText::_('JYES'); ?>
							</label>
							<input type="radio" id="rsformConfig_imgresize_do_xs0" name="rsformConfig[imgresize_do_xs]" value="0" <?php if ($do_xs == 0) echo 'checked="checked"';?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_xs_width]" id="rsformConfig_imgresize_xs_width" value="<?php echo $xs_width;?>" />
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_xs_height]" id="rsformConfig_imgresize_xs_height" value="<?php echo $xs_height;?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<fieldset id="rsformConfig_imgresize_do_sm" class="btn-group radio">
							<input type="radio" id="rsformConfig_imgresize_do_sm1" name="rsformConfig[imgresize_do_sm]" value="1" <?php if ($do_sm == 1) echo 'checked="checked"';?> />
							<label for="rsformConfig_imgresize_do_sm1" >
								<?php echo JText::_('JYES'); ?>
							</label>
							<input type="radio" id="rsformConfig_imgresize_do_sm0" name="rsformConfig[imgresize_do_sm]" value="0" <?php if ($do_sm == 0) echo 'checked="checked"';?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_sm_width]" id="rsformConfig_imgresize_sm_width" value="<?php echo $sm_width;?>" />
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_sm_height]" id="rsformConfig_imgresize_sm_height" value="<?php echo $sm_height;?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<fieldset id="rsformConfig_imgresize_do_md" class="btn-group radio">
							<input type="radio" id="rsformConfig_imgresize_do_md1" name="rsformConfig[imgresize_do_md]" value="1" <?php if ($do_md == 1) echo 'checked="checked"';?> />
							<label for="rsformConfig_imgresize_do_md1" >
								<?php echo JText::_('JYES'); ?>
							</label>
							<input type="radio" id="rsformConfig_imgresize_do_md0" name="rsformConfig[imgresize_do_md]" value="0" <?php if ($do_md == 0) echo 'checked="checked"';?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_md_width]" id="rsformConfig_imgresize_md_width" value="<?php echo $md_width;?>" />
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_md_height]" id="rsformConfig_imgresize_md_height" value="<?php echo $md_height;?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<fieldset id="rsformConfig_imgresize_do_lg" class="btn-group radio">
							<input type="radio" id="rsformConfig_imgresize_do_lg1" name="rsformConfig[imgresize_do_lg]" value="1" <?php if ($do_lg == 1) echo 'checked="checked"';?> />
							<label for="rsformConfig_imgresize_do_lg1" >
								<?php echo JText::_('JYES'); ?>
							</label>
							<input type="radio" id="rsformConfig_imgresize_do_lg0" name="rsformConfig[imgresize_do_lg]" value="0" <?php if ($do_lg == 0) echo 'checked="checked"';?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_lg_width]" id="rsformConfig_imgresize_lg_width" value="<?php echo $lg_width;?>" />
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
					...
					<div class="controls">
						<input class="input-small" type="text" name="rsformConfig[imgresize_lg_height]" id="rsformConfig_imgresize_lg_height" value="<?php echo $lg_height;?>" />
					</div>
				</div>
			</fieldset>
		</div>
